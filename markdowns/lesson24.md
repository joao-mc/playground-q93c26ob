...
+ Quando uma função não for retornar valor (procedimento), utilize <b>void</b> como tipo da função. Quando se usa <b>void</b> não se pode usar <b>return</b> na função.
